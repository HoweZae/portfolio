...
<header class="bg-slate-800 p-5 rounded-xl">
    ...
    <p class="text-l text-slate-400">
        ...
        Thanks for visiting this page, it's nice to meet you!
        <br>
...
<div class="flex my-5">
    <div class="basis-1/2 bg-slate-800 mr-3 p-5 rounded-xl">
        <h2 class="text-xl">What have I been up to?</h2>
        <h3>
            See these in full detail in <a class="underline text-slate-300" href={link.li}>LinkedIn</a>.
            Here are my highlights:
        </h3>
    </div>

    <div class="basis-1/2 bg-slate-800 ml-3 p-5 rounded-xl">
        <h2 class="text-xl">What projects have I made?</h2>
        <h3>
            See these in full detail in <a class="underline text-slate-300" href={link.gh}>GitHub</a>.
            Here are my highlights:
        </h3>
    </div>
</div>

<div class="bg-slate-800 my-5 p-5 rounded-xl">
...
<div class="bg-slate-800 my-5 p-5 rounded-xl">
    <h3 class="text-white-900 text-justify">
